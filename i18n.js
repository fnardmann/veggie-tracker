...
const TRANSLATIONS = {
  en: {
    ...
    nutrition_totals_note:      'sum of all portions logged · from logged plants only · reference values based on DGE',
    nutrition_sugg_heading:     'What to Eat More Of',
    nutrition_sugg_note:        'ranked by how many of your nutrient gaps each food addresses · reference values based on DGE',
    ...
    settings_foodfacts_desc:            'Show a random food fact on the home screen.',
    settings_funfacts_heading:          'Nutrient Facts',
    settings_funfacts_title:            'Show nutrient fact',
    settings_funfacts_desc:             'Show a random nutrient fact at the top of the Nutrition tab.',
    ...
    settings_seasonal_title:      'Boost in-season foods',
    settings_seasonal_desc:       'Foods currently in season in your region are ranked higher and marked with a badge.',
    seasonal_de:                  'Germany',
    seasonal_at:                  'Austria',
    ...
    fact_vitd:    'Almost no Vitamin D in plants — go outside! 🌞 Fun fact: place mushrooms gill-side up in direct sunlight for 20 minutes and they produce a meaningful dose of Vitamin D — just like your skin does.',
    ...
    settings_excluded_heading:          'Excluded from Recommendations',
    settings_excluded_desc:             'Foods you never want suggested — removed from both plant and animal recommendations.',
    excluded_placeholder:               'Food name…',
    excluded_add:                       'Exclude',
    excluded_none:                      'No foods excluded.',
    ...
    food_db_note:                       'search any food · shows all nutrients per typical portion',
    food_db_search_placeholder:         'Search any food…',
    food_db_no_match:                   'No foods found.',
    food_db_no_data:                    'No nutrient data yet for this food.',
    food_db_portion_label:              'Portion',
    food_db_more_results:               '…and {n} more — refine your search',
    col_portion:                'portion',
    total_this_week:            'Total this week',
    all_logged:                 'All logged plants',
    no_data_week:               'No data this week',
    no_data_vitd:               'Go outside! ☀️ Plants barely have any.',
    hint_vitd:                  'Go outside! ☀️ Plants have almost none — sunlight is the main source.',
    pct_per_week:               '% / week',
    no_data_b12:                'Plants have none — time to take your supplement! 💊',
    logged_this_nutrient:       'Your plants this week',
    would_improve:               'Would improve',
    poorplant_b12:    'Plants contain no B12. Consider a supplement and/or animal products. Best animal sources: liver, oysters, mackerel, eggs.',
    poorplant_vitd:   'Plants have almost no Vitamin D. Main sources: sunlight ☀️, oily fish, eggs. Best plant option: sun-dried mushrooms (gills up, 20 min).',
    poorplant_b1:     'Plants are a weak B1 source per portion. Main sources: pork, wholegrains, fortified cereals. Best plants: sunflower seeds, lentils, oats.',
    poorplant_b2:     'Plants have little B2. Main sources: dairy, eggs, liver. Best plants: almonds, mushrooms, spinach.',
    poorplant_b3:     'Plants have limited B3. Main sources: meat, poultry, fish. Best plants: mushrooms, peanuts, sunflower seeds.',
    poorplant_calcium:'Plants provide some calcium but absorption is lower than from dairy. Best plants: tofu (calcium-set), kale, almonds, fortified plant milk.',
    ...
    poorplant_zinc:   'Plants contain zinc but phytates reduce absorption. Main sources: meat, shellfish. Best plants: pumpkin seeds, lentils, chickpeas.',
    poorplant_b5:     'B5 is found in almost all foods but plant portions are small. Best plants: sunflower seeds, mushrooms, avocado, sweet potato.',
    poorplant_potassium:'Potassium is abundant in bananas, potatoes, and spinach. Plants have less than animal sources. Best plants: sweet potato, spinach, white beans, avocado.',
    poorplant_iron:   'Plant (non-haem) iron is poorly absorbed. Combine with Vitamin C! Best plants: lentils, chickpeas, spinach, pumpkin seeds, tofu.',
    ...
    poorplant_vite:   'Vitamin E is found mainly in nuts and seeds. Best plants: almonds, sunflower seeds, pumpkin seeds, spinach.',
    poorplant_vitc:   'Vitamin C is in many fruits and vegetables. Best plants: pepper, kiwi, strawberries, broccoli, kale.',
    poorplant_vitk:   'Vitamin K1 is in plants; K2 comes from fermentation. Best: kale, spinach, broccoli, Brussels sprouts.',
    poorplant_fibre:  'Fibre is almost exclusively in plants. Best sources: lentils, black beans, oats, pear, artichoke.',
    poorplant_b6:     'B6 in plants is well absorbed. Best: chickpeas, banana, potato, spinach, sesame seeds.',
    poorplant_b9:     'Folate is in leafy vegetables and legumes. Best: spinach, broccoli, Brussels sprouts, lentils, asparagus.',
